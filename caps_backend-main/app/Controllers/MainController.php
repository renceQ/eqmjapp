...
//             'UPC' => $this->request->getPost('UPC'),
//             'product_description' => $this->request->getPost('product_description'),
//             // Adjust the image path to include the second 'caps_backend-main' directory
//             'image' => base_url() . $this->handleImageUpload($image, $prods),
//             // Adjust the barcode image path to include the second 'caps_backend-main' directory
//             'barcode_image' => base_url() . 'caps_backend-main/public/uploads/' . $barcodeImageName . '.png',
//         ];
...
// public function handleImageUpload($image, $prods)
// {
//     // Save the image with the correct file path
//     $image->move(ROOTPATH . 'public/uploads/', $prods);
//     // Return the correct file path for saving in the database
//     return 'caps_backend-main/public/uploads/' . $prods;
// }
